...
from app.assistant_v2.transfer.graph.tool import tool_list, tool_names
from app.assistant_v2.transfer.graph.utils import chain_ainvoke, extract_tool_messages
...
async def call_model_func(
    ...
    prompt_name: str = settings.transfer_v2_extract_info_prompt,
    prompt_label: str = settings.transfer_v2_extract_info_prompt_label,
) -> Dict[str, Any]:
    ...
    while True:
        ...
        if new_message:
            ...
            break
    output[TransferAgentStateFields.MESSAGES] = [response]
